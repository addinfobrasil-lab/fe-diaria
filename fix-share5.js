...
const start = t.indexOf('async function shareText(text, title) {');
const endMark = '// Uses Google Gemini';
...
`;
fs.writeFileSync('3-Codigo-do-App-Real/src/fe-diaria-app.jsx', before+neW+after, 'utf8');
console.log('done');
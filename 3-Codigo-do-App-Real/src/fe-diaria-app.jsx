...
/* ============================== CONTENT DATA ============================== */
const WEEKDAYS_PT = ["Domingo","Segunda-feira","Ter├ºa-feira","Quarta-feira","Quinta-feira","Sexta-feira","S├íbado"];
const MONTHS_PT = ["janeiro","fevereiro","mar├ºo","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];

// 31 items each ÔÇö one per day of the month, cycling automatically every month
const VERSES = [
  { ref: "Jeremias 29:11", text: "Eu conhe├ºo os planos que tenho para voc├¬, diz o Senhor: planos de fazer o bem, e n├úo o mal, para dar a voc├¬ um futuro e uma esperan├ºa." },
  { ref: "Salmos 23:1", text: "O Senhor ├® o meu pastor; nada me faltar├í." },
  { ref: "Filipenses 4:13", text: "Tudo posso naquele que me fortalece." },
  { ref: "Prov├®rbios 3:5-6", text: "Confie no Senhor de todo o cora├º├úo e n├úo se apoie apenas no seu pr├│prio entendimento." },
  { ref: "Isa├¡as 41:10", text: "N├úo temas, porque eu estou contigo; n├úo te assombres, porque eu sou o teu Deus." },
  { ref: "Mateus 11:28", text: "Venham a mim todos os que est├úo cansados e sobrecarregados, e eu darei descanso a voc├¬s." },
  { ref: "Salmos 46:1", text: "Deus ├® o nosso ref├║gio e a nossa for├ºa, um socorro sempre presente na ang├║stia." },
  { ref: "Romanos 8:28", text: "Todas as coisas cooperam para o bem daqueles que amam a Deus." },
  { ref: "Jo├úo 3:16", text: "Deus amou o mundo de tal maneira que entregou o seu ├║nico Filho, para que todo aquele que nele cr├¬ tenha a vida eterna." },
  { ref: "N├║meros 6:24-26", text: "Que o Senhor te aben├ºoe e te guarde; que o Senhor fa├ºa resplandecer o seu rosto sobre ti e te d├¬ paz." },
  { ref: "Salmos 27:1", text: "O Senhor ├® a minha luz e a minha salva├º├úo; a quem temerei?" },
  { ref: "Isa├¡as 40:31", text: "Os que esperam no Senhor renovam as suas for├ºas e voam alto como ├íguias." },
  { ref: "Josu├® 1:9", text: "Seja forte e corajoso, n├úo tenha medo nem desanime, pois o Senhor estar├í com voc├¬ por onde voc├¬ andar." },
  { ref: "Salmos 34:18", text: "Perto est├í o Senhor dos que t├¬m o cora├º├úo quebrantado e salva os de esp├¡rito abatido." },
  { ref: "Prov├®rbios 16:3", text: "Entregue ao Senhor tudo o que voc├¬ faz, e os seus planos ser├úo bem-sucedidos." },
  { ref: "G├ílatas 6:9", text: "N├úo nos cansemos de fazer o bem, pois no tempo certo colheremos, se n├úo desistirmos." },
  { ref: "1 Cor├¡ntios 13:4", text: "O amor ├® paciente, o amor ├® bondoso, n├úo inveja, n├úo se vangloria." },
  { ref: "Salmos 121:2", text: "O meu socorro vem do Senhor, que fez os c├®us e a terra." },
  { ref: "Ef├®sios 2:8", text: "Voc├¬s s├úo salvos pela gra├ºa, por meio da f├® ÔÇö e isso n├úo vem de voc├¬s, ├® dom de Deus." },
  { ref: "Mateus 6:33", text: "Busquem em primeiro lugar o Reino de Deus, e todas essas coisas ser├úo acrescentadas a voc├¬s." },
  { ref: "Salmos 37:4", text: "Agrade-se do Senhor, e ele atender├í aos desejos do seu cora├º├úo." },
  { ref: "Tiago 1:5", text: "Se algum de voc├¬s tem falta de sabedoria, pe├ºa-a a Deus, que a todos d├í livremente, sem repreender." },
  { ref: "2 Cor├¡ntios 12:9", text: "A minha gra├ºa ├® suficiente para voc├¬, pois o meu poder se aperfei├ºoa na fraqueza." },
  { ref: "Salmos 91:1-2", text: "Aquele que habita no esconderijo do Alt├¡ssimo descansar├í ├á sombra do Onipotente." },
  { ref: "Prov├®rbios 17:22", text: "O cora├º├úo alegre ├® bom rem├®dio, mas o esp├¡rito abatido seca os ossos." },
  { ref: "Hebreus 11:1", text: "A f├® ├® a certeza daquilo que esperamos e a prova das coisas que ainda n├úo vemos." },
  { ref: "Salmos 139:14", text: "Eu te louvo porque me fizeste de modo especial e admir├ível; maravilhosas s├úo as tuas obras." },
  { ref: "Colossenses 3:23", text: "Tudo o que fizerem, fa├ºam de todo o cora├º├úo, como para o Senhor, e n├úo para os homens." },
  { ref: "1 Pedro 5:7", text: "Lancem sobre ele toda a sua ansiedade, porque ele tem cuidado de voc├¬s." },
  { ref: "Salmos 16:11", text: "Tu me far├ís conhecer a vereda da vida; na tua presen├ºa h├í plenitude de alegria." },
  { ref: "Apocalipse 21:4", text: "Ele enxugar├í dos olhos de voc├¬s toda l├ígrima; n├úo haver├í mais morte, nem tristeza, nem choro, nem dor." },
];

const PRAYERS = [
  { title: "Ora├º├úo da Manh├ú", text: "Senhor, obrigado por mais este dia. Antes de tudo, coloco minha vida em Tuas m├úos. Guia os meus passos, acalma minha mente e enche meu cora├º├úo de Tua paz. Am├®m." },
  { title: "Ora├º├úo de Gratid├úo", text: "Pai, hoje quero parar e agradecer. Obrigado pela vida, pela fam├¡lia, pelo teto e pelo p├úo de cada dia. Ensina-me a viver agradecido. Am├®m." },
  { title: "Ora├º├úo por Sabedoria", text: "Senhor, tenho decis├Áes importantes pela frente e n├úo quero andar sozinho. D├í-me discernimento para escolher o que ├® certo. Am├®m." },
  { title: "Ora├º├úo pela Fam├¡lia", text: "Pai, coloco minha fam├¡lia em Tuas m├úos. Protege cada um, restaura o que estiver quebrado e fortalece os la├ºos entre n├│s. Am├®m." },
  { title: "Ora├º├úo por Paz", text: "Senhor, minha mente est├í cheia de preocupa├º├Áes. Pe├ºo que a Tua paz, que excede todo entendimento, guarde meu cora├º├úo agora. Am├®m." },
  { title: "Ora├º├úo pelo Trabalho e Sustento", text: "Deus, aben├ºoa o trabalho das minhas m├úos. Prov├¬ o que preciso e livra-me da ansiedade pelo dia de amanh├ú. Am├®m." },
  { title: "Ora├º├úo da Noite", text: "Senhor, obrigado por este dia que se encerra. Perdoa onde falhei e recebe minha gratid├úo. Descanso em Tuas m├úos essa noite. Am├®m." },
  { title: "Ora├º├úo por Sa├║de", text: "Senhor, tu ├®s o Deus que cura. Toco hoje diante de ti minha sa├║de e a de quem amo. Fortalece o meu corpo e renova minhas for├ºas. Am├®m." },
  { title: "Ora├º├úo por Prote├º├úo", text: "Pai, cobre a minha vida e a da minha fam├¡lia com a tua prote├º├úo hoje. Que nenhum mal se aproxime da nossa morada. Am├®m." },
  { title: "Ora├º├úo por Restaura├º├úo", text: "Senhor, h├í ├íreas da minha vida que precisam da tua restaura├º├úo. Onde h├í quebra, traz cura; onde h├í perda, traz reposi├º├úo. Am├®m." },
  { title: "Ora├º├úo por Dire├º├úo", text: "Deus, n├úo sei qual caminho tomar. Guia os meus passos e fecha as portas erradas com a mesma clareza com que abres as certas. Am├®m." },
  { title: "Ora├º├úo pelos Filhos", text: "Pai, entrego meus filhos em tuas m├úos. Guarda o cora├º├úo deles e cerca-os de pessoas que os ajudem a te conhecer. Am├®m." },
  { title: "Ora├º├úo pela Igreja", text: "Senhor, aben├ºoa a tua igreja. Une os que fazem parte dela e usa cada um de n├│s para edificar o Teu Reino. Am├®m." },
  { title: "Ora├º├úo por Quem Sofre", text: "Deus, hoje levanto diante de ti quem est├í sofrendo. Aproxima-te de quem chora e s├¬ o consolo que s├│ tu podes dar. Am├®m." },
  { title: "Ora├º├úo por Paci├¬ncia", text: "Senhor, ensina-me a esperar sem ansiedade. D├í-me paci├¬ncia com os outros e comigo mesmo, enquanto tu trabalhas no tempo certo. Am├®m." },
  { title: "Ora├º├úo Pedindo Perd├úo", text: "Pai, reconhe├ºo onde falhei. Perdoa o meu pecado e limpa o meu cora├º├úo. Ajuda-me a caminhar de forma diferente. Am├®m." },
  { title: "Ora├º├úo Concedendo Perd├úo", text: "Senhor, h├í algu├®m que me machucou e ainda carrego esse peso. Ajuda-me a perdoar como fui perdoado. Am├®m." },
  { title: "Ora├º├úo por Alegria", text: "Deus, enche o meu cora├º├úo de alegria genu├¡na hoje, n├úo porque tudo est├í resolvido, mas porque tu est├ís comigo. Am├®m." },
  { title: "Ora├º├úo por Contentamento", text: "Senhor, ensina-me a estar satisfeito com o que tenho hoje, sem deixar de sonhar com o que vir├í. Am├®m." },
  { title: "Ora├º├úo por um Novo Come├ºo", text: "Pai, obrigado porque as tuas miseric├│rdias se renovam a cada manh├ú. Hoje eu escolho recome├ºar. Am├®m." },
  { title: "Ora├º├úo por Coragem", text: "Deus, d├í-me coragem para enfrentar o que hoje me assusta. Lembra-me de que tu j├í foste antes de mim nesse caminho. Am├®m." },
  { title: "Ora├º├úo por Cura", text: "Senhor, tu conheces cada dor que carrego. Toca o que precisa ser curado e me sustenta enquanto isso acontece. Am├®m." },
  { title: "Ora├º├úo por Favor", text: "Pai, pe├ºo o teu favor sobre o meu dia: nas conversas, nas decis├Áes e nas portas que ainda vou encontrar. Am├®m." },
  { title: "Ora├º├úo por Boas Decis├Áes", text: "Senhor, tenho escolhas importantes pela frente. Tira de mim a pressa e me d├í clareza para decidir. Am├®m." },
  { title: "Ora├º├úo por Unidade", text: "Deus, onde h├í divis├úo ├á minha volta, usa-me como instrumento de paz e unidade. Am├®m." },
  { title: "Ora├º├úo por Pureza de Cora├º├úo", text: "Pai, examina o meu cora├º├úo e revela o que n├úo te agrada. Quero pensamentos que reflitam quem tu ├®s. Am├®m." },
  { title: "Ora├º├úo por Generosidade", text: "Senhor, abre as minhas m├úos. Ensina-me a dar com alegria, sem medo de que vai faltar. Am├®m." },
  { title: "Ora├º├úo por Perseveran├ºa", text: "Deus, quando a vontade de desistir bater, lembra-me de todas as vezes que tu j├í me sustentaste at├® aqui. Am├®m." },
  { title: "Ora├º├úo de Esperan├ºa", text: "Pai, quando o cen├írio parecer dif├¡cil de mudar, ajuda-me a lembrar que a esperan├ºa em ti nunca decepciona. Am├®m." },
  { title: "Ora├º├úo de F├®", text: "Senhor, aumenta a minha f├®. Nas coisas que ainda n├úo vejo, ajuda-me a confiar no teu car├íter, que j├í conhe├ºo. Am├®m." },
  { title: "Ora├º├úo de Entrega", text: "Deus, hoje eu escolho entregar nas tuas m├úos o que insisto em carregar sozinho. Assume o controle da minha vida. Am├®m." },
];

const MOMENTS = [
  { theme: "Confian├ºa", intro: "H├í dias em que n├úo entendemos o caminho, mas podemos confiar em quem o tra├ºa. Respire fundo e solte o que est├í tentando controlar sozinho.", verseRef: "Prov├®rbios 3:5-6" },
  { theme: "Gratid├úo", intro: "Antes de pedir qualquer coisa, pare e agrade├ºa. A gratid├úo muda a forma como enxergamos o nosso dia.", verseRef: "1 Tessalonicenses 5:18" },
  { theme: "Perd├úo", intro: "Perdoar n├úo ├® esquecer, ├® escolher a liberdade em vez do peso que voc├¬ carrega.", verseRef: "Ef├®sios 4:32" },
  { theme: "Esperan├ºa", intro: "Mesmo na espera, h├í esperan├ºa. Deus n├úo chega atrasado, ainda que o rel├│gio pare├ºa dizer o contr├írio.", verseRef: "Romanos 15:13" },
  { theme: "Paz", intro: "Voc├¬ n├úo precisa resolver tudo hoje. Use esta pausa apenas para respirar na presen├ºa de Deus.", verseRef: "Filipenses 4:6-7" },
  { theme: "Prop├│sito", intro: "Sua vida n├úo ├® acidente. H├í um prop├│sito sendo tecido, mesmo nos dias mais incertos.", verseRef: "Jeremias 29:11" },
  { theme: "Renovo", intro: "Cansa├ºo n├úo ├® o fim da linha. Deus renova as for├ºas de quem espera nele.", verseRef: "Isa├¡as 40:31" },
  { theme: "Coragem", intro: "O medo conta uma hist├│ria. Deus, muitas vezes, conta outra. Hoje, escolha acreditar na vers├úo dele.", verseRef: "Josu├® 1:9" },
  { theme: "Humildade", intro: "Grandeza, no Reino de Deus, parece muito com servi├ºo. Onde voc├¬ pode se colocar em ├║ltimo lugar hoje?", verseRef: "Filipenses 2:3" },
  { theme: "Alegria", intro: "Alegria n├úo ├® aus├¬ncia de problema, ├® a presen├ºa de Deus no meio dele. Deixe-se alegrar, mesmo que s├│ um pouco.", verseRef: "Neemias 8:10" },
  { theme: "Paci├¬ncia", intro: "Nem tudo floresce no seu tempo. Respire. O que Deus est├í construindo em voc├¬ n├úo tem pressa.", verseRef: "G├ílatas 6:9" },
  { theme: "Generosidade", intro: "M├úos fechadas n├úo recebem nada de novo. O que voc├¬ pode soltar hoje, em confian├ºa?", verseRef: "2 Cor├¡ntios 9:7" },
  { theme: "Descanso", intro: "Voc├¬ n├úo foi criado para funcionar sem parar. Descansar tamb├®m ├® um ato de f├®.", verseRef: "├èxodo 20:8-10" },
  { theme: "Cura", intro: "H├í feridas que s├│ o tempo com Deus consegue tratar. Permita-se sentir, diante dele, o que ainda d├│i.", verseRef: "Salmos 147:3" },
  { theme: "Provis├úo", intro: "Antes de voc├¬ pedir, Deus j├í sabe do que voc├¬ precisa. Descanse nisso por um instante.", verseRef: "Mateus 6:31-32" },
  { theme: "Unidade", intro: "Ningu├®m caminha essa f├® sozinho. Pense em algu├®m que Deus colocou ao seu lado ÔÇö e agrade├ºa por essa pessoa.", verseRef: "Eclesiastes 4:9-10" },
  { theme: "Pureza", intro: "O que voc├¬ tem alimentado nos seus pensamentos ultimamente? Convide Deus para essa parte tamb├®m.", verseRef: "Filipenses 4:8" },
  { theme: "Sabedoria", intro: "Voc├¬ n├úo precisa ter todas as respostas hoje. S├│ precisa perguntar a quem as tem.", verseRef: "Tiago 1:5" },
  { theme: "Vit├│ria", intro: "A batalha que parece maior que voc├¬ n├úo ├® maior que Deus. Lembre disso antes de continuar o dia.", verseRef: "1 Cor├¡ntios 15:57" },
  { theme: "Identidade", intro: "Antes de qualquer t├¡tulo ou fun├º├úo, voc├¬ ├® filho ou filha. Deixe essa verdade te sustentar hoje.", verseRef: "1 Jo├úo 3:1" },
  { theme: "Chamado", intro: "Deus n├úo chama os prontos, prepara os chamados. Onde voc├¬ sente um chamado ainda pequeno, comece.", verseRef: "Jeremias 1:5" },
  { theme: "Adora├º├úo", intro: "Adorar ├® lembrar quem ├® maior. Por um minuto, deixe de olhar pro problema e olhe s├│ para Deus.", verseRef: "Salmos 34:3" },
  { theme: "Servi├ºo", intro: "O maior entre voc├¬s ser├í aquele que serve. Quem voc├¬ pode servir, sem que ningu├®m veja, hoje?", verseRef: "Marcos 10:43-44" },
  { theme: "Comunh├úo", intro: "F├® tamb├®m se vive em comunidade. Pense em algu├®m que voc├¬ precisa reencontrar ou ligar hoje.", verseRef: "Hebreus 10:24-25" },
  { theme: "F├®", intro: "F├® n├úo ├® a aus├¬ncia de d├║vida, ├® escolher confiar mesmo com ela. Onde voc├¬ precisa dar esse passo hoje?", verseRef: "Marcos 9:24" },
  { theme: "Entrega", intro: "Existe algo que voc├¬ est├í segurando com as duas m├úos, com medo de largar. Deus tem m├úos maiores que as suas.", verseRef: "Salmos 55:22" },
  { theme: "Restaura├º├úo", intro: "O que parece quebrado demais para Deus consertar ainda n├úo passou pelas m├úos dele. D├¬ esse espa├ºo a ele agora.", verseRef: "Joel 2:25" },
  { theme: "Prote├º├úo", intro: "Voc├¬ n├úo caminha exposto. Ainda que n├úo veja, h├í uma cobertura sobre a sua vida.", verseRef: "Salmos 91:4" },
  { theme: "Favor", intro: "Pe├ºa hoje, sem medo, pelo favor de Deus sobre o seu dia ÔÇö nas pessoas, nas portas, nas conversas.", verseRef: "Salmos 5:12" },
  { theme: "Recome├ºo", intro: "Hoje pode ser o primeiro dia de algo novo. As miseric├│rdias de Deus se renovam a cada manh├ú.", verseRef: "Lamenta├º├Áes 3:22-23" },
  { theme: "Gratid├úo em Prova├º├úo", intro: "Mesmo no meio da dificuldade, existe algo pelo qual agradecer. Encontre isso agora, mesmo que pequeno.", verseRef: "1 Tessalonicenses 5:18" },
];

const REFLECTIONS = [
  "O que Deus tem falado ao seu cora├º├úo essa semana?",
  "Cite tr├¬s coisas pelas quais voc├¬ ├® grato hoje.",
  "Existe algu├®m que voc├¬ precisa perdoar ou pedir perd├úo?",
  "Onde voc├¬ tem buscado seguran├ºa al├®m de Deus?",
  "O que est├í pesando no seu cora├º├úo agora? Escreva sem filtro.",
  "Como voc├¬ pode servir algu├®m ├á sua volta hoje?",
  "O que significa, na pr├ítica, confiar em Deus em meio ├á espera?",
  "Qual medo voc├¬ precisa entregar a Deus hoje?",
  "Em que ├írea da sua vida voc├¬ tem tentado controlar tudo sozinho?",
  "Que promessa de Deus voc├¬ precisa lembrar agora?",
  "Como tem sido a sua vida de ora├º├úo ultimamente?",
  "O que voc├¬ faria diferente hoje se realmente confiasse em Deus?",
  "Quem, na sua vida, precisa ver o amor de Deus atrav├®s de voc├¬?",
  "O que voc├¬ tem aprendido com as dificuldades recentes?",
  "Existe algo que voc├¬ prometeu a Deus e ainda n├úo cumpriu?",
  "O que ocupa o primeiro lugar no seu cora├º├úo hoje?",
  "Como voc├¬ tem cuidado do seu corpo, que ├® templo de Deus?",
  "Que h├íbito voc├¬ gostaria de construir na sua vida espiritual?",
  "Em que momento recente voc├¬ sentiu a presen├ºa de Deus mais perto?",
  "O que a paz de Deus significaria, na pr├ítica, para o seu dia hoje?",
  "Existe alguma ├írea escondida da sua vida que Deus est├í pedindo para iluminar?",
  "Como voc├¬ tem tratado as pessoas mais pr├│ximas de voc├¬?",
  "O que te impede de descansar de verdade?",
  "Que passo pequeno de f├® voc├¬ pode dar hoje?",
  "Quando foi a ├║ltima vez que voc├¬ celebrou o que Deus j├í fez?",
  "O que voc├¬ tem feito com os talentos que Deus te confiou?",
  "Existe uma m├ígoa antiga que ainda influencia suas decis├Áes hoje?",
  "Como est├í a sua generosidade ÔÇö com tempo, dinheiro e aten├º├úo?",
  "O que a sua rotina revela sobre as suas prioridades reais?",
  "Que palavra voc├¬ acredita que Deus quer que voc├¬ guarde para hoje?",
  "Se hoje fosse o ├║ltimo dia, o que voc├¬ mudaria agora mesmo?",
];

const HELP_CONTENT = {
  financeira: [
    { title: "D├¡zimo e generosidade", text: "Dar n├úo ├® sobre quanto sobra, ├® sobre confian├ºa. Comece com o que voc├¬ tem e um cora├º├úo disposto a partilhar." },
    { title: "Or├ºamento com prop├│sito", text: "Anote entradas e sa├¡das por 30 dias antes de cortar qualquer gasto. Voc├¬ n├úo consegue administrar o que n├úo enxerga." },
    { title: "Livre das d├¡vidas", text: "Liste as d├¡vidas da menor para a maior. Quitar a menor primeiro d├í o impulso emocional para seguir at├® o fim." },
    { title: "Contentamento", text: "Contentamento n├úo ├® se acomodar, ├® ter paz enquanto se trabalha, com sabedoria, por algo melhor." },
  ],
  espiritual: [
    { title: "Um h├íbito de ora├º├úo", text: "Comece com 5 minutos, sempre no mesmo hor├írio. Const├óncia pequena vence intensidade espor├ídica." },
    { title: "Jejum: primeiros passos", text: "Jejue uma refei├º├úo com um prop├│sito claro de ora├º├úo. N├úo ├® sobre passar fome, ├® sobre abrir espa├ºo." },
    { title: "Estudo b├¡blico pessoal", text: "Escolha um livro pequeno da B├¡blia e leia um cap├¡tulo por dia, anotando uma frase que tocou voc├¬." },
    { title: "Adora├º├úo no dia a dia", text: "Adorar n├úo ├® s├│ cantar aos domingos. ├ë reconhecer a Deus em cada tarefa simples da rotina." },
  ],
  emocional: [
    { title: "Ansiedade e f├®", text: "Coloque em palavras, na ora├º├úo, exatamente o que te preocupa. Nomear o medo j├í tira parte do seu peso." },
    { title: "Esperan├ºa na tristeza", text: "Tristeza n├úo ├® falta de f├®. Muitos salmos come├ºam em lamento antes de chegar ├á esperan├ºa." },
    { title: "O poder do perd├úo", text: "Perdoar algu├®m ├®, antes de tudo, um presente que voc├¬ entrega para si mesmo." },
    { title: "Quando Deus parece distante", text: "Sentimentos mudam, mas a fidelidade de Deus n├úo depende de como voc├¬ se sente hoje." },
  ],
  casamento: [
    { title: "Comunica├º├úo que une", text: "Separem 10 minutos por dia, sem celular, s├│ para se ouvirem de verdade." },
    { title: "Reacender a intimidade", text: "Pequenos gestos di├írios pesam mais do que grandes datas espor├ídicas no calend├írio." },
    { title: "Perd├úo no casamento", text: "Discutir ├® normal em qualquer casal. Quem fortalece a rela├º├úo ├® quem escolhe reconciliar primeiro." },
    { title: "Orando como casal", text: "Orar juntos, mesmo que por 2 minutos, cria uma intimidade que a rotina sozinha n├úo constr├│i." },
  ],
};

// Sem limite de quantidade: pode ter quantos itens quiser, a lista rola.
// Para a foto: no seu an├║ncio no Mercado Livre, clique com o bot├úo direito na
// foto principal do produto -> "Copiar endere├ºo da imagem" -> cole em "image".
// Deixe "" (vazio) se ainda n├úo tiver a foto ÔÇö aparece um ├¡cone no lugar.
const AFFILIATE_PRODUCTS = [
  { name: "B├¡blia Letra Gigante com Harpa", desc: "Capa luxo preta, RC (Revista e Corrigida)", url: "https://meli.la/2tT9L5y", image: "data:image/jpeg;base64," },
...
const BIBLE_BOOKS = [
  ...
  { name: "1 Cr├┤nicas", abbrev: "1cr", chapters: 29, t: "AT" }, { name: "2 Cr├┤nicas", abbrev: "2cr", chapters: 36, t: "AT" },
  { name: "Esdras", abbrev: "ed", chapters: 10, t: "AT" }, { name: "Neemias", abbrev: "ne", chapters: 13, t: "AT" },
  { name: "Ester", abbrev: "et", chapters: 10, t: "AT" }, { name: "J├│", abbrev: "job", chapters: 42, t: "AT" },
  { name: "Salmos", abbrev: "sl", chapters: 150, t: "AT" }, { name: "Prov├®rbios", abbrev: "pv", chapters: 31, t: "AT" },
  { name: "Eclesiastes", abbrev: "ec", chapters: 12, t: "AT" }, { name: "Cantares", abbrev: "ct", chapters: 8, t: "AT" },
  { name: "Isa├¡as", abbrev: "is", chapters: 66, t: "AT" }, { name: "Jeremias", abbrev: "jr", chapters: 52, t: "AT" },
  { name: "Lamenta├º├Áes", abbrev: "lm", chapters: 5, t: "AT" }, { name: "Ezequiel", abbrev: "ez", chapters: 48, t: "AT" },
  { name: "Daniel", abbrev: "dn", chapters: 12, t: "AT" }, { name: "Os├®ias", abbrev: "os", chapters: 14, t: "AT" },
  { name: "Joel", abbrev: "jl", chapters: 3, t: "AT" }, { name: "Am├│s", abbrev: "am", chapters: 9, t: "AT" },
  { name: "Obadias", abbrev: "ob", chapters: 1, t: "AT" }, { name: "Jonas", abbrev: "jn", chapters: 4, t: "AT" },
  { name: "Miqu├®ias", abbrev: "mq", chapters: 7, t: "AT" }, { name: "Naum", abbrev: "na", chapters: 3, t: "AT" },
  ...
  { name: "Lucas", abbrev: "lc", chapters: 24, t: "NT" }, { name: "Jo├úo", abbrev: "jo", chapters: 21, t: "NT" },
  { name: "Atos", abbrev: "at", chapters: 28, t: "NT" }, { name: "Romanos", abbrev: "rm", chapters: 16, t: "NT" },
  { name: "1 Cor├¡ntios", abbrev: "1co", chapters: 16, t: "NT" }, { name: "2 Cor├¡ntios", abbrev: "2co", chapters: 13, t: "NT" },
  { name: "G├ílatas", abbrev: "gl", chapters: 6, t: "NT" }, { name: "Ef├®sios", abbrev: "ef", chapters: 6, t: "NT" },
  ...
  { name: "1 Tim├│teo", abbrev: "1tm", chapters: 6, t: "NT" }, { name: "2 Tim├│teo", abbrev: "2tm", chapters: 4, t: "NT" },
  ...
  { name: "1 Jo├úo", abbrev: "1jo", chapters: 5, t: "NT" }, { name: "2 Jo├úo", abbrev: "2jo", chapters: 1, t: "NT" },
  { name: "3 Jo├úo", abbrev: "3jo", chapters: 1, t: "NT" }, { name: "Judas", abbrev: "jd", chapters: 1, t: "NT" },
...
// 24 real, verified songs ÔÇö one per day of month (repeats automatically every month)
const SONGS = [
  { title: "Ousado Amor", artist: "Isaias Saad", ytId: "wSKKEAnLTDw", category: "Adora├º├úo" },
  { title: "Bondade de Deus", artist: "Isaias Saad", ytId: "VPOCqNnBBtc", category: "Adora├º├úo" },
  { title: "Lugar Secreto", artist: "Gabriela Rocha", ytId: "V12T7cbEBMc", category: "Adora├º├úo" },
  { title: "Qu├úo Grande ├ë o Meu Deus", artist: "Soraya Moraes", ytId: "2nJ7-CsbmS0", category: "Louvor" },
  { title: "Deus ├® Deus", artist: "Delino Mar├ºal", ytId: "OP79d1jsz20", category: "Louvor" },
  { title: "Eu Navegarei", artist: "Gabriela Rocha", ytId: "nSvxVCdj_gU", category: "Reflexivo" },
  { title: "Uma Nova Hist├│ria", artist: "Fernandinho", ytId: "SdkWBHLHTgg", category: "Reflexivo" },
  { title: "Era a M├úo de Deus", artist: "Isaias Saad", ytId: "Z6ldpH6V1-o", category: "Louvor" },
  { title: "Ningu├®m Explica Deus", artist: "Preto no Branco ft. Gabriela Rocha", ytId: "LYsaKn8FRhc", category: "Louvor" },
  ...
  { title: "Tua Gra├ºa Me Basta", artist: "Davi Sacer ft. Preto no Branco", ytId: "F9hWwTQ4MKQ", category: "Adora├º├úo" },
  { title: "Amor do Pai", artist: "Aline Barros", ytId: "qiZJi1BtZjs", category: "Adora├º├úo" },
  { title: "O Grande Eu Sou", artist: "Bruna Karla", ytId: "jGzD-Yw0v-U", category: "Louvor" },
  { title: "├üguas Purificadoras / Oceanos", artist: "Isaias Saad ft. John Dias", ytId: "XUDifaNsjtA", category: "Adora├º├úo" },
  { title: "Reina Sobre Mim", artist: "N├¡vea Soares", ytId: "od4trd2rOkU", category: "Adora├º├úo" },
  { title: "Ele ├ë Exaltado", artist: "Aline Barros", ytId: "tAdSniZjaC0", category: "Louvor" },
  { title: "Nada Al├®m do Sangue", artist: "Fernandinho", ytId: "zmN6nFLgk4E", category: "Adora├º├úo" },
  ...
  { title: "Fiel ├ë Deus", artist: "Isaias Saad, Julliany Souza & L├®o Brand├úo", ytId: "cetVsAbaP3o", category: "Adora├º├úo" },
  { title: "Grande ├ë o Senhor", artist: "N├¡vea Soares", ytId: "pCWG_8xnuRA", category: "Louvor" },
...
const READING_PLAN = [
  "Um novo come├ºo", "Confian├ºa em meio ├á d├║vida", "O amor que n├úo falha", "Gratid├úo em todas as coisas",
  "For├ºa na fraqueza", "Perd├úo que liberta", "Paz que excede o entendimento", "F├® que move montanhas",
  "Esperan├ºa viva", "Sabedoria para decidir", "Generosidade de cora├º├úo", "Descanso em Deus",
  "Coragem para recome├ºar", "Amor ao pr├│ximo", "Alegria verdadeira", "Humildade e servi├ºo",
  "Perseveran├ºa na prova├º├úo", "A Palavra como l├ómpada", "Ora├º├úo sem cessar", "Fam├¡lia segundo o cora├º├úo de Deus",
  "Trabalho com prop├│sito", "Dom├¡nio pr├│prio", "Miseric├│rdia renovada", "Comunh├úo e igreja",
  "Identidade em Cristo", "Vencendo o medo", "Restaura├º├úo e cura", "Chamado e prop├│sito",
  "Adora├º├úo em esp├¡rito e verdade", "Celebrando a fidelidade de Deus",
];

const NAV_ITEMS = [
  { id: "home", label: "In├¡cio", icon: Home },
  { id: "biblia", label: "B├¡blia", icon: BookOpen },
...
const POST_CATEGORIES = [
  ...
  { id: "oracao", label: "Pedido de Ora├º├úo" },
  { id: "encorajamento", label: "Encorajamento" },
  { id: "versiculo", label: "Vers├¡culo" },
];
...
function timeAgo(ts) {
  ...
  if (m < 60) return `h├í ${m} min`;
  const h = Math.floor(m / 60);
  if (h < 24) return `h├í ${h}h`;
  ...
  try {
    ...
    if (typeof window !== "undefined" && window.Capacitor?.isNativePlatform?.()) {
      try {
        ...
        // 6 fundos natureza aleatórios - transmitem paz
        const NATURE = [
...
const MOCK_GEMINI_RESPONSE = {
  reflexao: "Que dia aben├ºoado! A gratid├úo transforma o comum em extraordin├írio.",
  livro: "Salmos",
  capitulo: 103,
  versiculo: "1-2",
  motivo: "Este salmo nos convida a bendizer ao Senhor por todos os seus benef├¡cios."
};
...
async function geminiFetch(path, text) {
  ...
  if (!url) throw new Error("Supabase URL n├úo configurada");
...
// Two-note synthesized chime (no audio files ÔÇö generated with the Web Audio API, so nothing to license)
function playChime(soundOn, variant = "confirm") {
  ...
  } catch { /* Web Audio unavailable ÔÇö stay silent, never block the interaction */ }
}
...
function StatusBar({ theme, onToggleTheme }) {
  ...
  return (
    <div className="flex items-center justify-between px-5 pt-3 pb-1">
      <span className="text-xs font-medium" style={{ color: T.text }}>F├® Di├íria</span>
        ...
        {AFFILIATE_PRODUCTS.map((p, i) => (
          <a key={i} href={p.url} target="_blank" rel="noopener noreferrer sponsored" className="shrink-0 rounded-xl overflow-hidden text-left block transition active:scale-95" style={{ backgroundColor: T.card, border: `1px solid ${T.border}`, width: 130 }}>
            ...
            <div className="p-2">
              ...
              <p className="text-xs mt-0.5" style={{ color: T.accent }}>Ver produto ÔåÆ</p>
            </div>
          </a>
        ))}
      </div>
  ...
  return (
    <div className="px-5 py-10 text-center">
      ...
      <button onClick={onOpenPremium} className="rounded-full px-6 py-2.5 text-sm font-semibold transition active:scale-95 flex items-center justify-center gap-2 mx-auto" style={{ backgroundColor: T.accent, color: T.onAccent }}>
        <Crown size={15} fill={T.onAccent} /> Virar Premium ┬À R$ 9,90/m├¬s
      </button>
    </div>
  );
}
  ...
  return (
    <Modal title={prayer.title} onClose={onClose}>
      ...
      <button onClick={onMarkPrayed} disabled={prayed} className="w-full mt-5 rounded-full py-3 text-sm font-medium flex items-center justify-center gap-2 transition active:scale-95" style={{ backgroundColor: prayed ? T.cardAlt : T.accent, color: prayed ? T.success : T.onAccent }}>
        {prayed ? (<><Check size={15} /> Voc├¬ orou hoje</>) : "Marcar como orado hoje"}
      </button>
    </Modal>
  );
}
...
function MomentModal({ moment, onClose }) {
  ...
  return (
    <Modal title={`Momento com Deus ┬À ${moment.theme}`} onClose={onClose}>
      ...
      <button onClick={() => { if (seconds === 0) { setSeconds(duration); setRunning(true); } else setRunning((r) => !r); }} className="w-full mt-4 rounded-full py-3 text-sm font-medium transition active:scale-95" style={{ backgroundColor: T.accent, color: T.onAccent }}>
        {running ? "Pausar" : seconds === 0 ? "Recome├ºar" : "Come├ºar pausa guiada"}
      </button>
...
function ReflectionModal({ question, text, setText, onClose }) {
  const T = useTheme();
  return (
    <Modal title="Momento de Reflex├úo" onClose={onClose}>
      ...
      <p className="text-xs mt-2" style={{ color: T.textMuted }}>Suas anota├º├Áes de hoje ficam salvas automaticamente neste dispositivo.</p>
    </Modal>
  );
}
...
function PremiumModal({ isPremium, onBuy, onRestore, onClose, savedEmail }) {
  ...
  const benefits = [
    "Sem nenhum an├║ncio, em nenhuma tela",
    "Acesso ├á IA: sugest├úo de passagem b├¡blica para o seu di├írio",
    "Acesso ao Mural da Comunidade: posts, amigos e mensagens",
    "Assinatura mensal ÔÇö cancele quando quiser",
    "Ajuda a manter o projeto no ar",
  ];
  const payLabel = payMode === "stripe" ? "Assinar por R$ 9,90/m├¬s (Stripe)" : payMode === "play" ? "Assinar na Google Play" : "Assinar Premium ┬À R$ 9,90/m├¬s";
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      if (mode !== "demo") {
        // Para Play e Stripe, a confirma├º├úo real acontece fora do app.
        alert(payMode === "stripe"
          ? "Voc├¬ ser├í levado ├á p├ígina do Stripe para assinar. Ao concluir, volte ao app e confirme o mesmo e-mail usado no pagamento."
          : "A assinatura ser├í conclu├¡da pela Google Play. Ao finalizar, o Premium ativa automaticamente.");
        if (payMode === "play") onBuy();
      } else {
        onBuy();
      }
    } catch (e) {
      alert("N├úo foi poss├¡vel concluir a assinatura. " + (e?.message || "Tente novamente."));
  ...
  const handleVerifyStripe = async () => {
    ...
    try {
      ...
      if (paid) {
        onBuy(email);
        alert("Assinatura confirmada! Premium ativo. ­ƒÆø");
      } else {
        alert("Ainda n├úo encontramos uma assinatura ativa para esse e-mail. Confirme se digitou o mesmo e-mail usado no pagamento e tente de novo em alguns segundos.");
      }
    } finally { setBusy(false); }
  };

  return (
    <Modal title={isPremium ? "F├® Di├íria Premium" : "F├® Di├íria Premium"} onClose={onClose}>
      <div className="text-center py-1">
        ...
        {isPremium ? (
          <>
            <p className="text-sm font-medium" style={{ color: T.text }}>Voc├¬ j├í ├® Premium. Obrigado por apoiar este projeto! ­ƒÆø</p>
            <p className="text-xs mt-1.5" style={{ color: T.textMuted }}>Todos os an├║ncios foram removidos, para sempre.</p>
            {payMode === "play" && (
              <button onClick={async () => { setBusy(true); try { if (await checkEntitlement()) { onBuy(); alert("Compra confirmada! Premium ativo."); } else { alert("Nenhuma compra encontrada nesta conta."); } } finally { setBusy(false); } }} disabled={busy} className="mt-4 text-xs underline" style={{ color: T.textMuted }}>
                {busy ? "Verificando..." : "J├í paguei ÔÇö verificar compra"}
              </button>
            )}
            {payMode === "stripe" && (
              <div className="mt-4">
            ...
            {payMode !== "play" && payMode !== "stripe" && (
              <button onClick={onRestore} className="mt-4 text-xs underline" style={{ color: T.textMuted }}>Restaurar an├║ncios (modo demonstra├º├úo)</button>
            )}
          </>
        ) : (
          <>
            <p className="text-sm mb-4 leading-relaxed" style={{ color: T.text }}>Uma experi├¬ncia completa e sem interrup├º├Áes, com um pre├ºo de caf├® por m├¬s ÔÇö cancele quando quiser.</p>
            ...
            <p className="text-xs mt-3 leading-relaxed" style={{ color: T.textMuted }}>
              {payMode === "play"
                ? "Assinatura mensal pela Google Play (R$ 9,90/m├¬s). Renova automaticamente e voc├¬ pode cancelar quando quiser."
                : payMode === "stripe"
                  ? "Assinatura mensal por cart├úo via Stripe (R$ 9,90/m├¬s). O link abre no navegador ÔÇö sem precisar da Play Store."
                  : "Sistema de pagamento ainda n├úo configurado. Configure VITE_REVENUECAT_API_KEY (Google Play) ou VITE_STRIPE_PAYMENT_LINK para cobran├ºa real. Por enquanto, a assinatura ├® apenas simulada para testes."}
            </p>
            {payMode === "stripe" && (
              <div className="mt-5 pt-4 border-t" style={{ borderColor: T.border }}>
                <p className="text-xs font-medium mb-2" style={{ color: T.text }}>J├í assinou? Ative o Premium:</p>
                <div className="flex gap-2">
                  <input
                    value={verifyEmail}
                    onChange={(e) => setVerifyEmail(e.target.value)}
  ...
  return (
    <Modal title="Tocando agora" onClose={onClose}>
      ...
      <a href={`https://www.youtube.com/watch?v=${song.ytId}`} target="_blank" rel="noopener noreferrer" className="mt-3 flex items-center justify-center gap-1.5 text-xs py-2.5 rounded-full" style={{ backgroundColor: T.cardAlt, color: T.accent }}>
        N├úo est├í tocando? Abrir no YouTube <ArrowRight size={12} />
      </a>
    </Modal>
  );
}
...
function ProfileModal({ user, onSignIn, onSignOut, onClose }) {
  ...
  const signInWithGoogle = async () => {
    ...
    } catch { alert("Falha ao conectar com Google. Verifique se o Supabase est├í configurado."); } finally {
      setLoading(false);
    }
  };
      ...
      if (isNative) {
        ...
        await window.Capacitor.Plugins.LocalNotifications.schedule({
          notifications: [{
            id: 1,
            title: "F├® Di├íria",
            body: "Hora do seu momento com Deus. ­ƒòè´©Å",
        ...
        setStatus(perm);
        if (perm === "granted") new Notification("F├® Di├íria", { body: "Lembretes di├írios ativados nesta aba Ô£Ø´©Å" });
      }
    } catch { setStatus("denied"); }
  };
    ...
    <div className="rounded-2xl p-3.5" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium" style={{ color: T.text }}>Lembrete di├írio</p>
          <p className="text-xs" style={{ color: T.textMuted }}>
            {!supported ? "N├úo suportado neste dispositivo" : status === "granted" ? `Ativado todos os dias ├ás ${String(hour).padStart(2, "0")}:${String(minute).padStart(2, "0")}` : isNative ? "Um aviso di├írio para seu momento com Deus" : "Um aviso para n├úo esquecer seu momento com Deus"}
          </p>
        </div>
      ...
      {supported && status !== "granted" && (
        <div className="flex items-center gap-2 mt-3">
          ...
          <span className="text-xs" style={{ color: T.textMuted }}>hor├írio do lembrete di├írio</span>
        </div>
      )}
      <p className="text-xs mt-2.5 leading-relaxed" style={{ color: T.textMuted }}>
        {isNative ? "No app instalado, o lembrete chega na tela do celular todos os dias no hor├írio escolhido." : "Dentro do navegador, o lembrete aparece enquanto a aba estiver aberta. No app instalado, chega de verdade na tela do celular todos os dias."}
      </p>
    </div>
  );
}
...
function HomeScreen({ verse, onOpen, doneCount, isPremium, songOfDay, onGoLouvor, lastRead, onContinueReading, user, onOpenProfile }) {
  ...
  const cards = [
    { id: "oracao", label: "Ora├º├úo do dia", desc: "Comece com uma palavra ao Pai", icon: MessageCircle },
    { id: "momento", label: "Momento com Deus", desc: "Uma pausa guiada de sil├¬ncio", icon: Flame },
    { id: "reflexao", label: "Reflex├úo do dia", desc: "Uma pergunta para o cora├º├úo", icon: Quote },
    { id: "louvor", label: "Louvor do dia", desc: `${songOfDay.title} ┬À ${songOfDay.artist}`, icon: Music },
  ];
  return (
    <div className="px-5 py-3 space-y-4">
      ...
      <div className="rounded-2xl p-4" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
        <div className="flex items-start justify-between gap-2">
          ...
          <button onClick={() => shareText(`ÔÇ£${verse.text}ÔÇØ\nÔÇö ${verse.ref}`, "Vers├¡culo do dia ÔÇö F├® Di├íria")} className="shrink-0 transition active:scale-95" title="Compartilhar"><Share2 size={15} style={{ color: T.textMuted }} /></button>
        </div>
        <p className="fd-display text-sm mt-2 leading-relaxed" style={{ color: T.text }}>ÔÇ£{verse.text}ÔÇØ</p>
...
function BibleScreen({ book, setBook, chapter, setChapter, cache, setCache, version, setVersion, favoriteVerses, toggleFavoriteVerse, lastRead, onMarkLastRead, isPremium }) {
  ...
  useEffect(() => {
    ...
    // Mostra o texto offline (B├¡blia embutida) imediatamente, sem depender da internet.
    if (offline) {
    ...
    (async () => {
      ...
      } catch { /* not cached yet ÔÇö will fetch live below */ }
      try {
      ...
      {showFavorites ? (
        <div className="space-y-2">
          {favoriteVerses.length === 0 ? (
            <p className="text-xs py-4 text-center leading-relaxed" style={{ color: T.textMuted }}>Voc├¬ ainda n├úo marcou nenhum vers├¡culo. Toque na estrela ao lado de um vers├¡culo para salv├í-lo aqui.</p>
        ...
        <>
          ...
          <div>
            <p className="text-xs uppercase tracking-wider mb-1.5" style={{ color: T.textMuted }}>{book.name} ┬À Cap├¡tulo</p>
          ...
          <div className="rounded-2xl p-4" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
            ...
            {verses ? (
              <div className="space-y-2">
                {verses.map((v) => {
                  ...
                  return (
                    <div key={v.v} className="flex items-start gap-2">
                      ...
                      <button onClick={() => shareText(`ÔÇ£${v.t}ÔÇØ\nÔÇö ${book.name} ${chapter}:${v.v}`, "Vers├¡culo ÔÇö F├® Di├íria")} className="shrink-0 mt-0.5" title="Compartilhar"><Share2 size={13} style={{ color: T.textMuted }} /></button>
                ...
                <p className="text-xs pt-1" style={{ color: T.textMuted }}>Texto de Almeida Atualizada embutido no app ÔÇö dispon├¡vel mesmo sem internet.</p>
              </div>
            ) : status === "error" ? (
              <div>
                {fallback ? (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs pt-1" style={{ color: T.textMuted }}>API offline ÔÇö mostrando texto salvo no app.</p>
                  </div>
                ) : (
                  <div className="text-center py-3">
                    <p className="text-xs mb-2 leading-relaxed" style={{ color: T.textMuted }}>Este cap├¡tulo ainda n├úo est├í dispon├¡vel offline. Conecte-se ├á internet para carreg├í-lo.</p>
...
function MusicScreen({ favorites, toggleFavorite, songOfDay, isPremium }) {
  ...
  const categories = ["Todos", "Adora├º├úo", "Louvor", "Reflexivo"];
  ...
  return (
    <div className="px-5 py-3 space-y-4">
      ...
      <p className="text-xs text-center pt-1" style={{ color: T.textMuted }}>Toque em uma m├║sica para tocar direto aqui no app.</p>
      {!isPremium && <MonetizationBlock />}
  ...
  return (
    <div className="px-5 py-3 space-y-5">
      ...
      <div className="rounded-2xl p-3.5 flex items-center gap-4" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
        <ProgressRing pct={progressPct} label="do m├¬s" />
        <div className="flex-1">
          <p className="text-sm font-medium" style={{ color: T.text }}>Progresso do m├¬s</p>
          <p className="text-xs mb-1.5" style={{ color: T.textMuted }}>{doneCount} de {totalDaysInMonth} dias conclu├¡dos</p>
      ...
      <div>
        <h3 className="fd-display text-sm mb-1" style={{ color: T.text }}>Di├írio do dia</h3>
        ...
        <button onClick={askAI} disabled={!journalText.trim() || aiStatus === "loading"} className="w-full mt-2.5 rounded-full py-2.5 text-sm font-medium flex items-center justify-center gap-2 transition active:scale-95" style={{ backgroundColor: isPremium ? T.accent : T.cardAlt, color: isPremium ? T.onAccent : T.text, opacity: !journalText.trim() || aiStatus === "loading" ? 0.5 : 1, border: isPremium ? "none" : `1px solid ${T.border}` }}>
          {isPremium ? <Sparkles size={15} /> : <Lock size={13} />} {aiStatus === "loading" ? "Lendo com carinho..." : isPremium ? "Pedir sugest├úo da IA" : "Sugest├úo da IA ┬À Premium"}
        </button>
        ...
        {aiStatus === "error" && (
          <p className="text-xs mt-2.5 text-center" style={{ color: T.textMuted }}>N├úo consegui pensar em uma sugest├úo agora. Tente de novo em instantes.</p>
        )}
        {journalSuggestion && aiStatus !== "loading" && (
          <div className="mt-2.5 rounded-2xl p-3.5" style={{ backgroundColor: T.cardAlt }}>
            <div className="flex items-center gap-1.5 mb-1.5"><Sparkles size={13} style={{ color: T.accent }} /><p className="text-xs uppercase tracking-wider font-semibold" style={{ color: T.accent }}>Sugest├úo da IA</p></div>
            ...
            {matchedBook && (
              <button onClick={() => onGoToPassage(matchedBook.name, Math.min(journalSuggestion.capitulo || 1, matchedBook.chapters))} className="flex items-center gap-1.5 text-xs mt-2.5 px-3 py-1.5 rounded-full transition active:scale-95" style={{ backgroundColor: T.accent, color: T.onAccent }}>
                Ler na B├¡blia <ArrowRight size={12} />
              </button>
            )}
            <p className="text-xs mt-2.5" style={{ color: T.textMuted }}>Sugest├úo gerada automaticamente ÔÇö n├úo substitui aconselhamento profissional.</p>
          </div>
        )}
        <p className="text-xs mt-2" style={{ color: T.textMuted }}>Seu di├írio ├® salvo automaticamente, apenas neste dispositivo.</p>
      </div>

      <div>
        <h3 className="fd-display text-sm mb-2.5" style={{ color: T.text }}>Plano de 30 dias ┬À F├® para Recome├ºar</h3>
        <div className="space-y-1.5">
...
function ChurchFinder() {
  ...
  const find = async () => {
    ...
    try {
      ...
      const msg = isDenied
        ? "Permiss├úo de localiza├º├úo negada. Ative nas configura├º├Áes e tente novamente."
        : "N├úo foi poss├¡vel obter sua localiza├º├úo. Verifique GPS/internet e tente novamente.";
      setStatus("error");
      setErrorMsg(msg);
    ...
    setStatus("loading");
    try {
      // Geocodifica├º├úo reversa (gr├ítis, OpenStreetMap Nominatim) ÔÇö s├│ para mostrar o nome da cidade
      const geoRes = await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${lat}&lon=${lon}&zoom=10`);
      const geoData = await geoRes.json();
      const addr = geoData.address || {};
      setCityName(addr.city || addr.town || addr.village || addr.county || "sua regi├úo");

      // Busca igrejas pr├│ximas (gr├ítis, OpenStreetMap Overpass API).
      // N├úo filtra religion na query porque muitas igrejas (sobretudo no Brasil)
      // n├úo t├¬m a tag "religion=christian" ÔÇö a filtragem ├® feita no cliente.
      // O raio ├® 8 km e o limite alto para n├úo cortar igrejas pr├│ximas;
      // a ordena├º├úo por dist├óncia e o corte para 20 ficam no cliente.
      ...
      // V├írios servidores Overpass para redund├óncia (o p├║blico tem rate limit).
      ...
      for (const server of overpassServers) {
        ...
        } catch { /* tenta o pr├│ximo servidor */ }
      }
      if (!opData) throw new Error("overpass falhou em todos os servidores");
      // Religi├Áes que n├úo s├úo crist├ús ÔÇö ignoradas; igrejas sem tag religiosa entram.
      ...
      const DENOM_LABELS = {
        catholic: "Cat├│lica", evangelical: "Evang├®lica", protestant: "Protestante",
        ...
        "jehovahs_witness": "Testemunhas de Jeov├í", assembly_of_god: "Assembleia de Deus",
      ...
      const describe = (c) => {
        ...
        if (c.religion === "christian" && !c.name) return "Igreja crist├ú";
        return "";
      };
      ...
      setStatus("error");
      setErrorMsg("N├úo consegui buscar igrejas agora. Tente novamente em instantes.");
    }
  };
  ...
  return (
    <div className="rounded-2xl p-3.5" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
      <div className="flex items-center gap-3 mb-1">
        ...
        <div className="flex-1"><p className="text-sm font-medium" style={{ color: T.text }}>Igrejas perto de voc├¬</p><p className="text-xs" style={{ color: T.textMuted }}>Usa sua localiza├º├úo + OpenStreetMap (gratuito)</p></div>
      </div>
      {status === "idle" && (
      ...
      {(status === "locating" || status === "loading") && (
        <div className="flex items-center gap-2 justify-center py-3">
          ...
          <span className="text-xs" style={{ color: T.textMuted }}>{status === "locating" ? "Obtendo sua localiza├º├úo..." : "Buscando igrejas pr├│ximas..."}</span>
        </div>
      )}
      {status === "error" && (
        <div className="text-center py-2">
      ...
      {status === "done" && (
        <div className="mt-2">
          ...
          {churches.length === 0 ? (
            <p className="text-xs" style={{ color: T.textMuted }}>Nenhuma igreja encontrada no mapa aberto (OpenStreetMap) perto de voc├¬ ainda ÔÇö a base de dados ├® colaborativa e pode ter lacunas na sua regi├úo. Tente novamente mais tarde.</p>
          ) : (
            <div className="space-y-1.5">
              {churches.map((c) => (
...
function HelpScreen({ isPremium, onOpenPremium, soundOn, onToggleSound, onOpenTerms, onExportData, onDeleteData, ageBracket }) {
  ...
  return (
    <div className="px-5 py-3 space-y-4">
      ...
      {(cat === "emocional" || cat === "casamento") && (<p className="text-xs leading-relaxed rounded-xl p-3" style={{ backgroundColor: T.cardAlt, color: T.textMuted }}>Este conte├║do tem car├íter devocional e n├úo substitui acompanhamento profissional. Em momentos mais dif├¡ceis, procure um conselheiro, pastor ou psic├│logo de confian├ºa.</p>)}

      <div className="pt-3 border-t" style={{ borderColor: T.border }}>
        <p className="text-xs uppercase tracking-wider mt-3 mb-2" style={{ color: T.textMuted }}>Perto de voc├¬</p>
        <ChurchFinder />
      </div>

      <div className="pt-1">
        <p className="text-xs uppercase tracking-wider mt-3 mb-2" style={{ color: T.textMuted }}>Prefer├¬ncias</p>
        <div className="space-y-2">
          <NotificationRow />
          <div className="rounded-2xl p-3.5 flex items-center gap-3" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
            ...
            <div className="flex-1"><p className="text-sm font-medium" style={{ color: T.text }}>Sons do app</p><p className="text-xs" style={{ color: T.textMuted }}>Um toque suave ao concluir ora├º├Áes e tarefas</p></div>
      ...
      <div>
        ...
        <button onClick={onOpenPremium} className="w-full rounded-2xl p-3.5 flex items-center gap-3 transition active:scale-95" style={{ backgroundColor: isPremium ? T.card : T.accent + "18", border: `1px solid ${isPremium ? T.border : T.accent}` }}>
          ...
          <div className="text-left flex-1"><p className="text-sm font-medium" style={{ color: T.text }}>{isPremium ? "Voc├¬ ├® Premium" : "Virar Premium"}</p><p className="text-xs" style={{ color: T.textMuted }}>{isPremium ? "Obrigado por apoiar o projeto ­ƒÆø" : "Sem an├║ncios ┬À assinatura de R$ 9,90/m├¬s"}</p></div>
      ...
      <div>
        ...
        <p className="text-xs mt-1.5" style={{ color: T.textMuted }}>Links de afiliado (ex.: Mercado Livre) ÔÇö voc├¬ recebe comiss├úo quando algu├®m compra por eles.</p>
      </div>
      <div className="rounded-2xl p-3.5" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
        <div className="flex items-center gap-3 mb-2.5">
          <ShieldCheck size={18} style={{ color: T.accent }} />
          <div className="flex-1"><p className="text-sm font-medium" style={{ color: T.text }}>Meus Dados</p><p className="text-xs" style={{ color: T.textMuted }}>Acesse, baixe ou apague seus dados ÔÇö direito seu pela LGPD</p></div>
        </div>
        <div className="flex gap-2">
          <button
            onClick={() => {
        ...
        {confirmDelete && (
          <div className="mt-2.5 rounded-xl p-3" style={{ backgroundColor: T.cardAlt }}>
            <p className="text-xs mb-2 leading-relaxed" style={{ color: T.text }}>Isso apaga para sempre seu progresso, di├írio, favoritos e login deste dispositivo. N├úo d├í para desfazer.</p>
            <div className="flex gap-2">
        ...
        <p className="text-xs mt-2.5" style={{ color: T.textMuted }}>Idade informada: {ageBracket === "18_plus" ? "18 ou mais" : ageBracket === "13_to_17" ? "13 a 17" : ageBracket === "under_13" ? "at├® 12" : "n├úo informada"}</p>
      </div>
      ...
      <p className="text-xs text-center pt-1 pb-1" style={{ color: T.textMuted }}>F├® Di├íria ┬À seus dados ficam salvos neste dispositivo</p>
...
function DMThread({ myName, otherName, onBack }) {
  ...
  const send = async () => {
    ...
    try {
      ...
      const updated = [...current, { id: uid(), from: myName || "An├┤nimo", text: t.slice(0, 500), ts: Date.now() }].slice(-300);
  ...
  return (
    <div className="flex flex-col" style={{ height: "100%" }}>
      ...
      <div className="rounded-xl p-2.5 mb-2 flex items-start gap-2" style={{ backgroundColor: T.cardAlt }}>
        ...
        <p className="text-xs leading-relaxed" style={{ color: T.textMuted }}>Mensagens salvas apenas neste dispositivo. N├úo ├® um servi├ºo de mensageria real ÔÇö evite compartilhar dados sens├¡veis.</p>
      </div>
...
function CommunityScreen({ user, hiddenPosts, onHidePost, likedPosts, onToggleLike }) {
  ...
  const submitPost = async () => {
    ...
    setPosting(true);
    try {
      // Modera├º├úo: se a IA falhar (sem internet/API), n├úo bloqueia a publica├º├úo.
      let moderation = { aprovado: true };
      try { moderation = await moderateText(t); } catch { moderation = { aprovado: true }; }
      if (!moderation.aprovado) {
        alert("Publica├º├úo recusada: " + (moderation.motivo || "conte├║do inadequado."));
        setPosting(false);
        return;
      }
      if (supabaseReady && user?.sub) {
        ...
        const newPost = { id: uid(), name: user ? user.name : "An├┤nimo", category, text: t.slice(0, 280), ts: Date.now(), likes: 0 };
      ...
      alert("N├úo foi poss├¡vel publicar agora. Verifique sua conex├úo e tente novamente.");
    ...
    <div className="flex flex-col" style={{ height: "100%" }}>
      ...
      {section === "amigos" && (
        <div className="px-5 py-2 space-y-3 flex-1 overflow-y-auto fd-scroll">
          ...
          {friends.length === 0 ? (
            <p className="text-xs text-center py-6 leading-relaxed" style={{ color: T.textMuted }}>Nenhum amigo ainda. Adicione algu├®m pelo nome para come├ºar a conversar.</p>
          ) : (
            <div className="space-y-2">
              {friends.map((f) => (
      ...
      {section === "mural" && (
        <div className="px-5 py-2 space-y-4 flex-1 overflow-y-auto fd-scroll">
          <div className="rounded-xl p-3 flex items-start gap-2" style={{ backgroundColor: T.cardAlt }}>
            ...
            <p className="text-xs leading-relaxed" style={{ color: T.textMuted }}>{supabaseReady ? (user?.sub ? "Mural p├║blico compartilhado com todos os usu├írios do F├® Di├íria. Suas publica├º├Áes aparecem para todo mundo." : "Para publicar e ver as publica├º├Áes de todos os usu├írios, entre com sua conta Google pelo ├¡cone do perfil na tela inicial.") : "Mural local ÔÇö vis├¡vel apenas neste dispositivo. Conecte o Supabase para compartilhar."}</p>
          </div>
          ...
          {status === "loading" ? (
            ...
            <p className="text-xs text-center py-6 leading-relaxed" style={{ color: T.textMuted }}>Ainda n├úo h├í publica├º├Áes. Seja a primeira pessoa a compartilhar algo hoje.</p>
          ) : (
            <div className="space-y-2">
              {visible.map((p) => {
                ...
                return (
                  <div key={p.id} className="rounded-2xl p-3.5" style={{ backgroundColor: T.card, border: `1px solid ${T.border}` }}>
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <div className="flex-1 min-w-0"><p className="text-xs font-medium truncate" style={{ color: T.text }}>{p.name}</p><p className="text-xs" style={{ color: T.textMuted }}>{catLabel} ┬À {timeAgo(p.ts)}</p></div>
  ...
  return (
    <Modal title="Termos de Uso e Privacidade" onClose={canDismiss ? onClose : () => {}}>
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className="text-xs" style={{ color: T.textMuted }}>Vers├úo {TERMS_VERSION}{!canDismiss ? " ┬À leia antes de continuar" : ""}</p>
      </div>
      <div className="space-y-3 text-xs leading-relaxed pr-1" style={{ color: T.text, maxHeight: 280, overflowY: "auto" }}>
        <p><b>1. Aceita├º├úo.</b> Ao usar o F├® Di├íria, voc├¬ concorda com estes termos e com a Pol├¡tica de Privacidade. Se n├úo concordar, n├úo continue usando o app.</p>
        <p><b>2. Natureza do conte├║do.</b> Este app tem finalidade devocional e educativa. Nada aqui substitui aconselhamento profissional m├®dico, psicol├│gico, financeiro, jur├¡dico ou pastoral.</p>
        <p><b>3. Mural da comunidade.</b> Espa├ºo p├║blico, n├úo moderado em tempo real por pessoas (h├í modera├º├úo autom├ítica por IA). Proibido discurso de ├│dio, ass├®dio, spam, conte├║do sexual, ilegal, ou exposi├º├úo de dados de terceiros.</p>
        <p><b>4. Dado sens├¡vel.</b> Conte├║do sobre f├® (ora├º├Áes, di├írio, publica├º├Áes) ├® considerado dado pessoal sens├¡vel pela LGPD (Art. 5┬║, II). Pedimos consentimento espec├¡fico para isso abaixo.</p>
        <p><b>5. Idade m├¡nima.</b> Mural e mensagens privadas s├úo recomendados apenas para maiores de 18 anos, dado o risco de contato com estranhos.</p>
        <p><b>6. Seus direitos.</b> Voc├¬ pode acessar, exportar ou apagar seus dados a qualquer momento em &quot;Meus Dados&quot;, em Ajuda+.</p>
        <p><b>7. IA.</b> Modera├º├úo e sugest├Áes usam intelig├¬ncia artificial e podem conter imprecis├Áes.</p>
        <p><b>8. Pagamentos.</b> Nesta vers├úo de demonstra├º├úo, remover an├║ncios n├úo realiza cobran├ºa real.</p>
        <p className="pt-1" style={{ color: T.textMuted }}>Modelo inicial de refer├¬ncia ÔÇö n├úo substitui revis├úo por advogado antes da publica├º├úo real.</p>
      </div>

      <div className="mt-3 pt-3 border-t" style={{ borderColor: T.border }}>
        <p className="text-xs font-medium mb-1.5" style={{ color: T.text }}>Qual ├® a sua idade?</p>
        <div className="flex gap-1.5 mb-3">
          {[{ id: "under_13", label: "At├® 12" }, { id: "13_to_17", label: "13 a 17" }, { id: "18_plus", label: "18 ou mais" }].map((o) => (
        ...
        {ageBracket && ageBracket !== "18_plus" && (
          <p className="text-xs mb-3 leading-relaxed rounded-xl p-2.5" style={{ backgroundColor: T.cardAlt, color: T.textMuted }}>Para menores de 18, o mural p├║blico e as mensagens privadas ficam desativados nesta conta, e o uso do app deve ser orientado por um respons├ível.</p>
        )}
        {ageBracket === "18_plus" && (
          <button onClick={() => setSensitiveConsent((s) => !s)} className="w-full flex items-start gap-2.5 text-left mb-1">
            ...
            <span className="text-xs leading-relaxed" style={{ color: T.text }}>Concordo especificamente com o tratamento do conte├║do de f├® que eu escrever (ora├º├Áes, di├írio, publica├º├Áes) como dado sens├¡vel, conforme a Pol├¡tica de Privacidade.</span>
          </button>
        )}
      </div>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      } catch { /* first time opening ÔÇö nothing saved yet */ }
      finally { if (!cancelled) setReady(true); }
    })();
    return () => { cancelled = true; };
  }, []);

  // Auto-verifica├º├úo da assinatura Stripe: se o e-mail verificado foi salvo,
  ...
  const TITLES = { biblia: "B├¡blia", louvor: "Louvor", agenda: "Agenda", mural: "Mural", ajuda: "Central de Apoio" };
  ...
  const mapSupabaseUser = (su) => {
    ...
    setUser({
      name: su.user_metadata?.full_name || su.user_metadata?.name || su.email?.split("@")[0] || "Usu├írio",
      email: su.email,
  ...
  useEffect(() => {
    ...
    // via scheme customizado, captura o token e cria a sess├úo no Supabase.
    ...
    if (typeof window !== "undefined" && window.Capacitor && window.Capacitor.Plugins?.App) {
      appListener = window.Capacitor.Plugins.App.addListener("appUrlOpen", async ({ url }) => {
        ...
        if (accessToken && refreshToken) {
          ...
          if (error) console.error("Falha ao restaurar sess├úo no app:", error.message);
        }
      });
    }
            ...
            <div className="relative overflow-hidden flex flex-col" style={{ backgroundColor: T.surface, height: isNative ? "100%" : 700, borderRadius: isNative ? 0 : 16 }}>
              ...
              {tab === "home" ? (
                <div className="px-5 pt-1 pb-1 flex items-center gap-1.5">
                  ...
                  <span className="fd-display text-sm tracking-wide" style={{ color: T.accent }}>F├ë DI├üRIA</span>
              ...
              <div key={tab} className="flex-1 overflow-y-auto fd-scroll fd-fadein">
                ...
                {tab === "mural" && (!isPremium ? (
                  <PremiumGate feature="O Mural da Comunidade conecta voc├¬ a outros leitores: publique testemunhos, envie mensagens privadas e forme amizades." onOpenPremium={() => setModal("premium")} />
                  ...
                  <div className="px-5 py-8 text-center">
                    ...
                    <p className="text-sm font-medium mb-1.5" style={{ color: T.text }}>Dispon├¡vel para maiores de 18</p>
              ...
              {splashPhase !== "gone" && (
                <div className="absolute inset-0 z-40 flex flex-col items-center justify-center gap-3" style={{ backgroundColor: T.surface, opacity: splashPhase === "out" ? 0 : 1, transition: "opacity 0.4s ease", pointerEvents: "none" }}>
                  ...
                  <span className="fd-display text-base tracking-wide" style={{ color: T.accent }}>F├ë DI├üRIA</span>

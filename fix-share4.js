...
const oldMatch = t.match(/async function shareText\(text, title\) \{[\s\S]*?alert\("Texto copiado[^}]*\}\s*\}/);
if(!oldMatch){console.log('not found');process.exit(1);}
